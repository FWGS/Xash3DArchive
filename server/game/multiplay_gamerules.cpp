...
void CHalfLifeMultiplay :: Think ( void )
{
	...
	if ( g_fGameOver )   // someone else quit the game already
	{
		...
		m_flIntermissionEndTime = g_flIntermissionStartTime + CVAR_GET_FLOAT( "mp_chattime" );
...
void CHalfLifeMultiplay :: ClientDisconnected( edict_t *pClient )
{
	if ( pClient )
	{
		...
		if ( pPlayer )
		{
			UTIL_FireTargets( "game_playerleave", pPlayer, pPlayer, USE_TOGGLE );
...
{
	return CVAR_GET_FLOAT( "mp_autocrosshair" ) ? TRUE : FALSE;
}
...
void CHalfLifeMultiplay :: PlayerKilled( CBasePlayer *pVictim, entvars_t *pKiller, entvars_t *pInflictor )
{
	...
	UTIL_FireTargets( "game_playerdie", pVictim, pVictim, USE_TOGGLE );
...
edict_t *CHalfLifeMultiplay::GetPlayerSpawnSpot( CBasePlayer *pPlayer )
{
	...
	if ( IsMultiplayer())
	{
		UTIL_FireTargets( pentSpawnSpot->v.target, pPlayer, pPlayer, USE_TOGGLE );
	}
...
{ 
	return CVAR_GET_FLOAT( "mp_flashlight" ) ? TRUE : FALSE; 
}
...
void CHalfLifeMultiplay :: GoToIntermission( void )
{
	...
	m_flIntermissionEndTime = gpGlobals->time + ((int)CVAR_GET_FLOAT( "mp_chattime" ));
