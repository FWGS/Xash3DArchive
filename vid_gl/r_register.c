...
convar_t *r_speeds;
convar_t *r_drawelements;
convar_t *r_fullbright;
convar_t *r_lightmap;
convar_t *r_novis;
convar_t *r_nocull;
convar_t *r_ignorehwgamma;
convar_t *r_check_errors;
convar_t *r_overbrightbits;
convar_t *r_vertexbuffers;
convar_t *r_flares;
convar_t *r_flaresize;
convar_t *r_flarefade;
convar_t *r_spriteflares;
convar_t *r_cullflares;
convar_t *r_dynamiclight;
convar_t *r_coronascale;
...
convar_t *r_portalmaps;
convar_t *r_portalmaps_maxtexsize;

convar_t *r_lighting_bumpscale;
convar_t *r_lighting_deluxemapping;
convar_t *r_lighting_diffuse2heightmap;
convar_t *r_lighting_specular;
convar_t *r_lighting_glossintensity;
convar_t *r_lighting_glossexponent;
convar_t *r_lighting_models_followdeluxe;
convar_t *r_lighting_ambientscale;
convar_t *r_lighting_directedscale;
convar_t *r_lighting_modulate;

convar_t *r_offsetmapping;
convar_t *r_offsetmapping_scale;
convar_t *r_offsetmapping_reliefmapping;

convar_t *r_occlusion_queries;
convar_t *r_occlusion_queries_finish;

convar_t *r_shadows;
convar_t *r_shadows_alpha;
convar_t *r_shadows_nudge;
convar_t *r_shadows_projection_distance;
convar_t *r_shadows_maxtexsize;
convar_t *r_shadows_pcf;
convar_t *r_shadows_self_shadow;

convar_t *r_bloom_alpha;
convar_t *r_bloom_diamond_size;
convar_t *r_bloom_intensity;
convar_t *r_bloom_darken;
convar_t *r_bloom_sample_size;
convar_t *r_bloom_fast_sample;

convar_t *r_allow_software;
convar_t *r_3dlabs_broken;

convar_t *r_decals;
convar_t *r_himodels;
convar_t *r_lefthand;
convar_t *r_physbdebug;

convar_t *r_environment_color;
