...
void PortalFlow (int portalnum)
{
	...
	MsgDev( D_INFO, "portal:%4i  mightsee:%4i  cansee:%4i (%i chains)\n", 
...
void PassageMemory(void)
{
	...
	MsgDev( D_INFO, "%7i average number of passages per leaf\n", totalportals / numportals);
	MsgDev( D_INFO, "%s required passage memory\n", memprint( totalmem ));
}
