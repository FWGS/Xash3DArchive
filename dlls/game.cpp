...
cvar_t	*fragsleft;	  	// Don't spam console/log files/users with this changing
cvar_t	*timeleft;	  	// "      "
...
void GameDLLInit( void )
{
	...
	teamplay = CVAR_REGISTER( "mp_teamplay", "0", FCVAR_SERVER, "sets to 1 to indicate teamplay" );
	fraglimit = CVAR_REGISTER( "mp_fraglimit", "0", FCVAR_SERVER, "limit of frags for current server" );
	timelimit = CVAR_REGISTER( "mp_timelimit", "0", FCVAR_SERVER, "server timelimit" );

	fragsleft = CVAR_REGISTER( "mp_fragsleft", "0", FCVAR_SERVER | FCVAR_UNLOGGED, "how many frags remaining" );
	timeleft = CVAR_REGISTER( "mp_timeleft", "0" , FCVAR_SERVER | FCVAR_UNLOGGED, "how many time remaining" );

	friendlyfire = CVAR_REGISTER( "mp_friendlyfire", "0", FCVAR_SERVER, "enables firedlyfire for teamplay" );
	falldamage = CVAR_REGISTER( "mp_falldamage", "0", FCVAR_SERVER, "falldamage multiplier" );
	weaponstay = CVAR_REGISTER( "mp_weaponstay", "0", FCVAR_SERVER, "weapon leave stays on ground" );
	forcerespawn = CVAR_REGISTER( "mp_forcerespawn", "1", FCVAR_SERVER, "force client respawn after his death" );
	flashlight = CVAR_REGISTER( "mp_flashlight", "0", FCVAR_SERVER, "attempt to use flashlight in multiplayer" );
	aimcrosshair = CVAR_REGISTER( "mp_autocrosshair", "1", FCVAR_SERVER, "enables auto-aim in multiplayer" );
	decalfrequency = CVAR_REGISTER( "decalfrequency", "30", FCVAR_SERVER, "how many decals can be spawned" );
	teamlist = CVAR_REGISTER( "mp_teamlist", "hgrunt,scientist", FCVAR_SERVER, "names of default teams" );
	...
	allowmonsters = CVAR_REGISTER( "mp_allowmonsters", "0", FCVAR_SERVER, "allow monsters in multiplayer" );

	mp_chattime = CVAR_REGISTER( "mp_chattime", "10", FCVAR_SERVER, "time beetween messages" );
