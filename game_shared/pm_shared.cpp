...
================
*/
int PM_AddToTouched(pmtrace_t tr, vec3_t impactvelocity)
{
	int i;
...
void PM_LadderMove( physent_t *pLadder )
{
	...
	VectorAdd( ladderCenter, pLadder->origin, ladderCenter ); // allow for ladders moving around
