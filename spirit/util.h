...
int PRECACHE_PARTICLE( char* s );		// classic precache 
int PRECACHE_PARTICLE( string_t s );		// pev->message as argument
int PRECACHE_PARTICLE( string_t s, char *e );	// custom particle precache
...
extern int	gmsgTempEntity;	// needs to be in global scope
