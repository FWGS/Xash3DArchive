...
int CHudGeiger::Draw( float flTime )
{
	...
	if( m_iGeigerRange < 1000 && m_iGeigerRange > 0 )
	{
		...
		{
			pct = 0;			//gEngfuncs.Con_Printf( "range > 800\n" );
		}
		else if( m_iGeigerRange > 600 )
		{
			pct = 2;
			flvol = 0.4;		//gEngfuncs.Con_Printf( "range > 600\n" );
			rg[0] = 1;
			rg[1] = 1;
			i = 2;
		}
		...
		{
			pct = 4;
			flvol = 0.5;		//gEngfuncs.Con_Printf( "range > 500\n" );
			rg[0] = 1;
			rg[1] = 2;
			i = 2;
		}
		...
		{
			pct = 8;
			flvol = 0.6;		//gEngfuncs.Con_Printf( "range > 400\n" );
			rg[0] = 1;
			rg[1] = 2;
			rg[2] = 3;
			i = 3;
		...
		{
			pct = 8;
			flvol = 0.7;		//gEngfuncs.Con_Printf( "range > 300\n" );
			rg[0] = 2;
			rg[1] = 3;
			rg[2] = 4;
			i = 3;
		...
		{
			pct = 28;
			flvol = 0.78;		//gEngfuncs.Con_Printf( "range > 200\n" );
			rg[0] = 2;
			rg[1] = 3;
			rg[2] = 4;
			i = 3;
		...
		{
			pct = 40;
			flvol = 0.80;		//gEngfuncs.Con_Printf( "range > 150\n" );
			rg[0] = 3;
			rg[1] = 4;
			rg[2] = 5;
			i = 3;
		...
		{
			pct = 60;
			flvol = 0.85;		//gEngfuncs.Con_Printf( "range > 100\n" );
			rg[0] = 3;
			rg[1] = 4;
			rg[2] = 5;
			i = 3;
